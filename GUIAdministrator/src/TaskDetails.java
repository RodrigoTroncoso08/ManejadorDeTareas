...
public class TaskDetails extends JPanel {
	...
	public TaskDetails() {
		...
		lblProceso.setBounds(30, 545, 69, 23);
		add(lblProceso);
		
		JSlider slider = new JSlider();
		slider.setBackground(new Color(30, 144, 255));
		slider.setForeground(new Color(64, 224, 208));
		slider.setBounds(61, 569, 200, 20);
		add(slider);
		
		JButton btnD = new JButton("+ D");
		btnD.setBounds(183, 442, 51, 23);
		add(btnD);
		
		JButton btnW = new JButton("+ W");
		btnW.setBounds(251, 442, 69, 23);
		add(btnW);
