...
public class Proyect {
	...
	int Progress;
	ArrayList<String> Members = new ArrayList<String>(); // la idea es tener los
															// email de quienes
															// participen del
															// proyecto
	Color color;
		...
		if (Tasks.isEmpty())
			...
			for (int i = 0; i < Tasks.size(); i++) {
				...
				if (Tasks.get(i).Deadline == null) {
					Tasks.add(i, t);
					break;
				} else if (Tasks.get(i).Deadline.compareTo(t.Deadline) < 0) // la
																			// tarea
																			// t
																			// viene
																			// despues
					...
					Tasks.add(i, t);
					return;
				} else if (Tasks.get(i).Deadline.compareTo(t.Deadline) == 0) // estan
																				// en
																				// la
																				// misma
																				// fecha
				{
					if (Tasks.get(i).WorkingDays >= t.WorkingDays) // el tiempo
																	// de
																	// trabajo
																	// de t es
																	// menor
