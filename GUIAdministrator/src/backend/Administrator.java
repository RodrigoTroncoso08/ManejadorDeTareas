...
public class Administrator {
	...
	ArrayList<String> PosibleContext; // restringe que los usuarios pongan
										// cualquier cosa en contexto
	...
	public boolean AddProyect(Proyect p) {
		...
		ArrayList<String> ar = ProjectNames(); // ingrresar no existe ya, se
												// ingresa y se
	...
	public Color AddContext(String cont) // //Al agregar un contexto revisa si
											// este ya existe y sino lo crea.
											// Devuelve el color asociado al
											// contexto
	{
	...
	/*
	 * estos metodos se basan en que al agrupar las tareas sin importar de que
	 * proyecto viene cada una, es como tener un solo gran proyecto al que se le
	 * agregan las tareas y ese calcula en orden cuales pertencen a que grupo.
	 * Para no perder la identificacion de la tarea, le agregue un identificador
	 * a la tarea con el numero de identificacion de su proyeto.
	 */
	public ArrayList<Task> TodayTasks() {

		Proyect aux = new Proyect("Aux"); // funcion add de proyect ya ordena
											// por fecha
		for (Proyect p : Proyects) {
