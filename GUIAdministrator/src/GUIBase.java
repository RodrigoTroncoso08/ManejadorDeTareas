...
public class GUIBase {
	...
	private void CreateAdmin() {
		// crea el administrador (parte fundamental del backend) y crea un
		// proyecto miscelaneo
		...
		GlosaryPanel.add(b);
		GlosaryPanel.setPreferredSize(new Dimension(GlosaryPanel
	...
	private void initialize() {
		...
		AddTask.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				NombreTarea.setFont(new Font("Arial Rounded MT Bold",
						Font.BOLD, 13));
				...
				Tnombre.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN,
						13));
				...
				ProyectoTarea.setFont(new Font("Arial Rounded MT Bold",
						Font.BOLD, 13));
				...
				Proyectos.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				ContextoTarea.setFont(new Font("Arial Rounded MT Bold",
						Font.BOLD, 13));
				...
				Contextos.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				FechaTarea.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				DiaTarea.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				MesTarea.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				AñoTarea.setFont(new Font("Arial Rounded MT Bold", Font.BOLD,
						13));
				...
				okbotom.addActionListener(new ActionListener() {
																...
																// Tarea
					{
						for (int i = 0; i < admin.getProyects().size(); i++) {
							if (admin.getProyects().get(i).getName() == Proyectos
									.getSelectedItem().toString()) {
								Task t = new Task(Tnombre.getText());
								Calendar c = Calendar.getInstance();
								c.clear();
								c.set(Integer.parseInt(Taño.getText()),
										Integer.parseInt(Tmes.getText()),
										Integer.parseInt(Tdia.getText()));
								t.setDeadline(c);
								t.setContext(admin
										.AddContext((String) Contextos
												.getSelectedItem()));
								admin.getProyects().get(i).AddTask(t);
								ProyectUI.get(i).AddTask(t); // es importante
																// que los
																// proyectos se
																// agreguen
																// logica y
						...
						Ask.dispose(); // pa cerrar el dialogo una vez que se
										// acepta
					}
				});
				okbotom.setForeground(new Color(153, 204, 255));
				okbotom.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN,
						13));
			...
			public void actionPerformed(ActionEvent e) {
				...
				okbotom.addActionListener(new ActionListener() {
																...
																// Proyecto
					{
						...
						ProyectUI.add(PP);
						WhiteBase.add(PP);
						WhiteBase.setPreferredSize(new Dimension(WhiteBase
								.getPreferredSize().width, WhiteBase
								.getPreferredSize().height + 140));
						WhiteBase.revalidate();
						WhiteBase.repaint();
						AddProject.setVisible(false);
						AddProject.dispose(); // pa cerrar el dialogo una vez
												// que se acepta
						...
						b.setForeground(Color.WHITE);
						b.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN,
								20));
						b.setBounds(10,
								5 + GlosaryPanel.getComponentCount() * 45, 150,
								35);
						GlosaryPanel.add(b);
						GlosaryPanel.setPreferredSize(new Dimension(
								GlosaryPanel.getPreferredSize().width,
								GlosaryPanel.getPreferredSize().height + 45));
						frame.revalidate();
						frame.repaint();
