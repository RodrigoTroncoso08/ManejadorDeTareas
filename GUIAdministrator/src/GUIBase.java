...
public class GUIBase {
	...
	private void initialize() {
		...
		//aca viene la parte de los detalles de las tareas, donde se pueden editar y todo eso
		//es un panel azul que deberia ir a la derecha de la pantalla y se hace visible solo
		//cuando se selecciona una tarea
		
		TaskDetail.setBackground(new Color(30, 144, 255));
		TaskDetail.setForeground(new Color(212, 227, 252));
		TaskDetail.setBounds(640, 22, 350, 545);
		...
		impo.setBounds(200, 28, 120, 20);
		impo.setModel(new DefaultComboBoxModel(new String[] {"Normal","Importante","Muy Importante"}));
		TaskDetail.add(impo);
		...
		//y hasta aca llegan los componentes del panel
		//como no se puede hacer regiones en eclipse
		//lo marco con comentarios
